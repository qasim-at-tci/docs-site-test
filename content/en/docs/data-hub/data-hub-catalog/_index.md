...
* **Administration** – Data Hub Admin can assign curator roles and curators can manage the list of owners
	  ...
	  The **Administration** tab will only be shown for those with curate roles (owners of a data source, curators or the Data Hub Admin.	
...
The Data Hub integration is available in Studio Pro version 8.14 and above. To use the latest functionality of Data Hub download the latest version of Studio Pro. 
