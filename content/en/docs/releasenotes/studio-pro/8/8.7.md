...
* When you open the [Update Widgets](/refguide8/project-menu#update-widgets) tool and your app contains a widget downloaded from the [App Store](https://appstore.home.mendix.com) that has since been removed from the App Store, this no longer results in an exception.
