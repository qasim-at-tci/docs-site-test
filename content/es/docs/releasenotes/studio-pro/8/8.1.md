---
title: "8.1"
url: /es/releasenotes/studio-pro/8.1
weight: 9
...
* We improved support for calling services that require an `Expect: 100-continue` HTTP header.
    This is based on an upvoted idea from [Edwin van Elk](https://forum.mendixcloud.com/link/questions/94038) submitted to the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thanks Edwin!
