---
title: "9.2"
url: /es/releasenotes/studio-pro/9.2
weight: 8
...
*  We added quick navigation from a [menu widget](/refguide/menu-widgets) to a navigation document.
	This is based on an [upvoted idea from Fabian Recktenwald](https://forum.mendixcloud.com/link/ideas/678) submitted to the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thanks, Fabian!
